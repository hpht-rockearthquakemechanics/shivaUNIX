...
ar=sqrt(F/Ma/pi/Pm); %raggio delle asperit� di contatto
Vw=ha*(pi*(2*ar)^2-pi*(ar^2)); %volume d'acqua tra le asperit�
vmod=smooth(v,500);
...
for m=3:M
    ...
    Ta(m)= dd; %sulle asperit� con acqua
